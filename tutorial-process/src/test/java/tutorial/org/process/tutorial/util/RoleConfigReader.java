 ...
 */
package tutorial.org.process.tutorial.util;
...
{
	public <R extends DsfRole> RoleConfig<R> read(String config, RoleConfig.DsfRoleFactory<R> dsfRoleFactory,
	...
	public <R extends DsfRole> RoleConfig<R> read(InputStream config, RoleConfig.DsfRoleFactory<R> dsfRoleFactory,
			Function<String, Coding> practitionerRoleFactory)
	{
		Objects.requireNonNull(config, "config");
		Objects.requireNonNull(dsfRoleFactory, "dsfRoleFactory");
