package org.example.process.tutorial.exercise_7.structuredefinition;

import static org.junit.Assert.assertEquals;
import static org.example.process.tutorial.ConstantsTutorial.CODESYSTEM_VOTING_PROCESS;
import static org.example.process.tutorial.ConstantsTutorial.CODESYSTEM_VOTING_PROCESS_VALUE_BINARY_QUESTION;
import static org.example.process.tutorial.ConstantsTutorial.PROFILE_TUTORIAL_TASK_START_VOTING_PROCESS;
import static org.example.process.tutorial.ConstantsTutorial.PROFILE_TUTORIAL_TASK_START_VOTING_PROCESS_INSTANTIATES_CANONICAL;
import static org.example.process.tutorial.ConstantsTutorial.PROFILE_TUTORIAL_TASK_START_VOTING_PROCESS_MESSAGE_NAME;
...
public class TaskStartVotingProcessTest
{
	...
	private Task createValidStartVotingProcessTask()
	{
		...
		votingResultExtension.setUrl("http://example.org/fhir/StructureDefinition/extension-voting-result");
