...
public interface ConstantsTutorial
{
	...
	String PROFILE_TUTORIAL_TASK_START_VOTING_PROCESS_AND_LATEST_VERSION = PROFILE_TUTORIAL_TASK_START_VOTING_PROCESS
			+ "|" + RESOURCE_VERSION;
	String PROFILE_TUTORIAL_TASK_VOTING_PROCESS_URI = "http://dsf.dev/bpe/Process/" + PROCESS_NAME_VOTING_PROCESS;
	String PROFILE_TUTORIAL_TASK_START_VOTING_PROCESS_INSTANTIATES_CANONICAL = PROFILE_TUTORIAL_TASK_VOTING_PROCESS_URI
			+ "|" + RESOURCE_VERSION;
	...
	String PROFILE_TUTORIAL_TASK_RETURN_VOTE_AND_LATEST_VERSION = PROFILE_TUTORIAL_TASK_RETURN_VOTE + "|"
			+ RESOURCE_VERSION;
	String PROFILE_TUTORIAL_TASK_RETURN_VOTE_INSTANTIATES_CANONICAL = PROFILE_TUTORIAL_TASK_VOTING_PROCESS_URI + "|"
			+ RESOURCE_VERSION;
	...
	String PROFILE_TUTORIAL_TASK_START_VOTE_AND_LATEST_VERSION = PROFILE_TUTORIAL_TASK_START_VOTE + "|"
			+ RESOURCE_VERSION;
	String PROFILE_TUTORIAL_TASK_VOTE_URI = "http://dsf.dev/bpe/Process/" + PROCESS_NAME_VOTE;
	String PROFILE_TUTORIAL_TASK_START_VOTE_INSTANTIATES_CANONICAL = PROFILE_TUTORIAL_TASK_VOTE_URI + "|"
			+ RESOURCE_VERSION;
