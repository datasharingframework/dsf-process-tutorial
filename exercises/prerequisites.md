...
## Java 25
Process plugins for the DSF are written using the [Java](https://www.java.com) programming language in version 25. Various open source releases of the Java Developer Kit (JDK) 25 exist, you are free in your choice.
